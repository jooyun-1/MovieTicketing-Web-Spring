               ...
               <div class="user-information">
                  <div id="test"  >
                     <div class="user-fav">
                        ...
                        <br>
                        <img src="/resources/images/cgv.png"  id="cgv"  alt="cgv" onclick="movie();">
                        <img src="/resources/images/megabox.png"  id="megabox"  alt="megabox" onclick="movie();">
                        <img src="/resources/images/lotte.png"   id="lotte" alt="lotte" onclick="movie();">
                        <br>
                        <br>
                        <br>
                        <br>
